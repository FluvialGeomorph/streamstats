...
#'                         include in response. See Feature resource for more
#'                         information. Default: true, returns delineated
#'                         basin and pourpoint.
#' @param crs	             string ESPSG spatial reference code. The function
#'                         sf::st_crs might come in handy.
#' @param simplify	       boolean;	Whether to simplify returned result,
#'                         defaut: true.
#' @export
getFeatures <- function(workspaceID,
                        rcode,
                        crs,
